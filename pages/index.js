      ...
      <div className="page-wrapper">
        ...
        <header className="hero-section">
          ...
          <div className="hero-content">
            ...
            <p className="hero-text" style={{ color: 'white' }}>
              Access <strong style={{ fontSize: '1.2em' }}>1100+</strong> essential school documents, past papers, and short notes from Grade 1 to A/L. 
        ...
        <main className="main-content" id="grades">
          <div className="section-header">
            ...
            <p>Access <strong style={{ color: 'var(--primary)', fontSize: '1.1em' }}>1100+ resources</strong> organized by grade and subject for quick access.</p>
          </div>
            ...
            <div className="content-wrapper">
              <div className="text-column">
                ...
                <ul className="feature-list">
                  <li>📚 <strong>1100+ Resources</strong> - Past papers, notes, and study materials</li>
